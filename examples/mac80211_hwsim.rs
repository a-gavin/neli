    ...
    for attr in attr_handle.iter() {
        match attr.nla_type().nla_type() {
            ...
            Mac80211HwsimAttr::RadioName => {
                // TODO: Doesn't print full name as string is not null-terminated in message
                let radio_name = attr.get_payload_as_with_len::<String>().unwrap();
                println!("{:<18}{}", "RadioName:", radio_name);
            }
            _ => (),
        }
    }
